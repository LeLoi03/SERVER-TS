...
//         const url = 'http://cs-conferences.acadiau.ca/ant-25/#importantDates';
...
const link1 = 'https://cs-conferences.acadiau.ca/ant-25/#callforPapers';
const link2 = 'https://cs-conferences.acadiau.ca/ant-25/#importantDates';

const urlWithoutHash = (urlString) => {
    const urlObj = new URL(urlString);
    return urlObj.origin + urlObj.pathname + urlObj.search;
};

console.log(urlWithoutHash(link1) === urlWithoutHash(link2)); // Sẽ in ra: true