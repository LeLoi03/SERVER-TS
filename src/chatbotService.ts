...
// src/chatbot-service.ts
import { handleUserInput } from './handlers/intentHandler';
import { saveHistoryToFile } from './utils/historyUtils';
import { ChatResponse, HistoryItem } from './shared/types';



async function runNonStreamChat(userInput: string, history: HistoryItem[]): Promise<ChatResponse> {
    return handleUserInput(userInput, history)
}
