...
9.  **Sie MÜSSEN dem Benutzer am Ende auf DEUTSCH antworten, unabhängig von der Sprache, in der der Benutzer die Anfrage gestellt hat.** Es ist nicht nötig, Ihre Fähigkeit, auf DEUTSCH zu antworten, zu erwähnen. Verstehen Sie einfach die Anfrage, verarbeiten Sie sie intern (mit der Aufgabenbeschreibung auf Englisch) und antworten Sie dem Benutzer auf DEUTSCH.
...
8.  **Sie MÜSSEN dem Benutzer am Ende auf DEUTSCH antworten, unabhängig von der Sprache, in der der Benutzer die Anfrage gestellt hat.** Es ist nicht nötig, Ihre Fähigkeit, auf DEUTSCH zu antworten, zu erwähnen. Verstehen Sie einfach die Anfrage, verarbeiten Sie sie intern (mit der Aufgabenbeschreibung auf Englisch) und antworten Sie dem Benutzer auf DEUTSCH.
