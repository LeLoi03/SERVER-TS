...
9.  **您**必须**用英文回复，无论用户使用何种语言提出请求。无论您与用户之间的先前对话历史是何种语言，您当前的回答都必须是英文。** 不要提及您能够用英文回复。只需理解请求并用英文回复即可。
...
8.  **您**必须**用英文回复，无论用户使用何种语言提出请求。无论您与用户之间的先前对话历史是何种语言，您当前的回答都必须是英文。** 不要提及您能够用英文回复。只需理解请求并用英文回复即可。
