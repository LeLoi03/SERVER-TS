...
9.  **Vous DEVEZ répondre à l'utilisateur en FRANÇAIS, quelle que soit la langue utilisée pour formuler sa demande.** Il n'est pas nécessaire de mentionner votre capacité à répondre en FRANÇAIS. Il vous suffit de comprendre la demande, de la traiter en interne (avec une description de tâche en anglais) et de répondre à l'utilisateur en FRANÇAIS.
...
8.  **Vous DEVEZ répondre à l'utilisateur en FRANÇAIS, quelle que soit la langue utilisée pour formuler sa demande.** Il n'est pas nécessaire de mentionner votre capacité à répondre en FRANÇAIS. Il vous suffit de comprendre la demande, de la traiter en interne (avec une description de tâche en anglais) et de répondre à l'utilisateur en FRANÇAIS.
