...
// const PORTAL = configService.config.PORTAL; // Lấy API key
// const BY = configService.config.BY; // Lấy API key
// const CORE = configService.config.CORE; // Lấy API key
// const SORT = configService.config.SORT; // Lấy API key
