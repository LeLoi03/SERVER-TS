...
export const CHANNEL: PlaywrightChannel = process.env.CHANNEL as any || 'chrome'; // Hoặc giá trị từ biến môi trường: process.env.PLAYWRIGHT_CHANNEL as PlaywrightChannel || 'chrome'
