...
export const MAX_SEARCH_RETRIES: number = 10;
...
export const GOOGLE_CUSTOM_SEARCH_API_KEYS: string[] = [
    ...
    process.env.CUSTOM_SEARCH_API_KEY_14,
    process.env.CUSTOM_SEARCH_API_KEY_15,
    process.env.CUSTOM_SEARCH_API_KEY_16,
    process.env.CUSTOM_SEARCH_API_KEY_17,
    process.env.CUSTOM_SEARCH_API_KEY_18,
    process.env.CUSTOM_SEARCH_API_KEY_19,
    process.env.CUSTOM_SEARCH_API_KEY_20,
    process.env.CUSTOM_SEARCH_API_KEY_21,
    process.env.CUSTOM_SEARCH_API_KEY_22,
    process.env.CUSTOM_SEARCH_API_KEY_23,
    process.env.CUSTOM_SEARCH_API_KEY_24,
    process.env.CUSTOM_SEARCH_API_KEY_25,
    process.env.CUSTOM_SEARCH_API_KEY_26,
    process.env.CUSTOM_SEARCH_API_KEY_27,
    process.env.CUSTOM_SEARCH_API_KEY_28,
    ...
    // process.env.CUSTOM_SEARCH_API_KEY_29,
    // process.env.CUSTOM_SEARCH_API_KEY_30,
