...
export class GeminiApiService {
    ...
    constructor(
        ...
        this.serviceBaseLogger = this.loggingService.getLogger({ service: 'GeminiApiService' });
    ...
    public async init(parentLogger?: Logger): Promise<void> {
        ...
        try {
            await this.cachePersistence.loadMap(this.loggingService.getLogger({ service: 'GeminiCachePersistenceService', operation: 'loadMapOnInit' }));
